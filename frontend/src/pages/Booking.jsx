...
const Booking = () => {
  ...
  // Fetch available slots based on selected service and date
  useEffect(() => {
      ...
      <div className="flex items-center mb-8">
        {steps.map((label, i) => (
          <div key={i} className="flex items-center w-full">
            <div className={`w-8 h-8 rounded-full flex items-center justify-center font-bold text-white text-sm ${step === i + 1 ? 'bg-blue-600' : i + 1 < step ? 'bg-green-600' : 'bg-gray-300'}`}>
              {i + 1}
            </div>
